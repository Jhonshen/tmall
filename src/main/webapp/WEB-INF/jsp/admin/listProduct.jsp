        ...
        <table class="table table-striped table-bordered table-hover  table-condensed">
            ...
            <c:forEach items="${ps}" var="p">
                ...
                <tr>
                    ...
                    <td><a href="admin_product_edit?id=${p.id}${page.param}"><span class="glyphicon glyphicon-edit"></span></a></td>
                    <td><a deleteLink="true" href="admin_product_delete?id=${p.id}${page.param}"><span class="   glyphicon glyphicon-trash"></span></a></td>
